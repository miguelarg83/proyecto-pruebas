<div class="flex space-x-1 justify-around">
    <a wire:click="$emitTo('modal','mostrarModal',{{ $id }})" class="p-1 text-teal-600 hover:bg-teal-600 hover:text-green rounded">
    ...
    <a href="{{ route('producto.edit', [$id]) }}" target="_blank" class="p-1 text-blue-600 hover:bg-blue-600 hover:text-white rounded">
